...
export class VehicleController {
    ...
    // Vehicles
    static getAllVehicles = async (req, res, next) => {
        try {
    ...
    static getVehicleById = async (req, res, next) => {
        try {
            const id = BigInt(req.params.id);
    ...
    static createVehicle = async (req, res, next) => {
        try {
    ...
    static updateVehicle = async (req, res, next) => {
        try {
            const id = BigInt(req.params.id);
    ...
    static deleteVehicle = async (req, res, next) => {
        try {
            const id = BigInt(req.params.id);
