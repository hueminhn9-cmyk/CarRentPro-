...
export class SettingController {
  static getSettingByKey = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  static getAllSettings = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  static updateSetting = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const key = req.params.key as string;
  ...
  static createSetting = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  static deleteSetting = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const key = req.params.key as string;
