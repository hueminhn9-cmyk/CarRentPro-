...
import {
  ...
  createHandoverRecordSchema,
} from '../validators/booking.validator.js';

export class BookingController {
  static createBooking = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
  ...
  static getBookingById = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
  ...
  static getAllBookings = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
  ...
  static updateStatus = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      const id = BigInt(req.params.id as string);
  ...
  static createHandover = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      const id = BigInt(req.params.id as string);
  ...
  static updateBooking = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      const id = BigInt(req.params.id as string);
  ...
  static deleteBooking = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      const id = BigInt(req.params.id as string);
