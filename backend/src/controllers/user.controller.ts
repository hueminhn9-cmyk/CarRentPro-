...
export class UserController {
  static getProfile = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
  ...
  static getUserById = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
  ...
  static getAllUsers = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
  ...
  static updateProfile = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      const userId = req.user!.id;
  ...
  static updateUserAdmin = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      const id = BigInt(req.params.id as string);
      const validatedBody = updateUserSchema.parse(req.body);
  ...
  static updateCustomerDetails = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      const userId = req.user!.id;
      const validatedBody = updateCustomerProfileSchema.parse(req.body);
      
      // Map ISO strings back to dates if present
      const customerData: any = { ...validatedBody };
  ...
  static verifyCustomer = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      const id = BigInt(req.params.id as string);
  ...
  static deleteUser = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      const id = BigInt(req.params.id as string);
  ...
  static uploadAvatar = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      if (!req.file) {
  ...
  static createUser = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
